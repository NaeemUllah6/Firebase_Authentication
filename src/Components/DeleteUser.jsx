...
const DeleteConfirmationModal = ({closeModal, successfullyDeleted}) => {
    ...
    return (
        ...
        <>
            <div className="fixed inset-0 flex items-center justify-center bg-white z-50 w-[calc(100%-240px)] ms-auto top-20">
                <div className="relative p-4 w-full max-w-md max-h-full">
                    <div className="relative bg-amber-100 rounded-lg shadow-sm dark:bg-gray-700">
                        ...
                        <div className="p-4 md:p-5 text-center">
                            ...
                            <button  onClick={successfullyDeleted} data-modal-hide="popup-modal" type="button" className="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                                Yes, I'm sure
                            </button>
